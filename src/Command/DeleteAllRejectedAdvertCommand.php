...
#[AsCommand(
    name: 'DeleteAllRejectedAdvert',
    description: 'Delete all rejected adverts created X days ago',
)]
class DeleteAllRejectedAdvertCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $io->success('Searching for rejected adverts created ' . $daysAgo . ' days ago...');

            $adverts = $this->entityManager->getRepository(Advert::class)->findBy([
                'state' => 'rejected',
            ...
            $io->success('All rejected adverts created ' . $daysAgo . ' days ago have been deleted.');
